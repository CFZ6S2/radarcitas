        ...
        {selectedProfile && (
          <div className="p-6 max-h-[85vh] overflow-y-auto">
            ...
            <a 
              ...
              className="flex items-center justify-center gap-2 w-full bg-green-600 hover:bg-green-500 text-white font-bold py-4 rounded-xl transition shadow-[0_0_20px_rgba(22,163,74,0.3)] sticky bottom-0"
            >
